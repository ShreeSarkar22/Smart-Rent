...
`Network Name: Localhost 8545 RPC URL: http://127.0.0.1:8545 Chain ID: 31337 (or 1337) Currency Symbol: ETH`
...
| Issue | Fix |
| --- | --- |
| "Nonce too high" | Clear MetaMask Activity Tab Data |
| "Contract not found" | Ensure App.js has the latest deployed contract address |
| App stuck on Landlord screen | Confirm MetaMask is on Localhost 8545 |
